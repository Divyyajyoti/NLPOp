...
def extract_combinatorial_data(problem_statement):
    ...
    2.  Extract the data: Extract the relevant data for the identified problem type. This might include a distance matrix (for TSP), a cost matrix (for Assignment), or values, weights, and capacity (for Knapsack), or a list of sets and the universe (for Set Covering).
