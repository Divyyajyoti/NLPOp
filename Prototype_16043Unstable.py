...
def generate_prompt(missing_type, variable_name=None, constraint_name=None):
    if missing_type == "bound_lower":
        return f"What should be the lower bound for the variable '{variable_name}'?"
    elif missing_type == "bound_upper":
        return f"What should be the upper bound for the variable '{variable_name}'?"
    elif missing_type == "A_eq":
        return f"What is the coefficient of variable '{variable_name}' in constraint '{constraint_name}'?"
    elif missing_type == "b_eq":
        return f"What is the right-hand side value for constraint '{constraint_name}'?"
    else:
