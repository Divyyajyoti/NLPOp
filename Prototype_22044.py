...
def extract_combinatorial_data(problem_statement):
    ...
    1.  Identify the problem type: Determine if it's a Traveling Salesman Problem (TSP), Assignment Problem, Knapsack Problem, or other.
    2.  Extract the data: Extract the relevant data for the identified problem type. This might include a distance matrix (for TSP), a cost matrix (for Assignment), or values, weights, and capacity (for Knapsack).
    ...
    {{
        "problem_type": "tsp" or "assignment" or "knapsack" or "unknown",
        "data": {{
            "distance_matrix": [[...], [...], ...],
            "cost_matrix": [[...], [...], ...],
