...
# --- Configure OpenAI ---
OPENAI_API_KEY = "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"
...
context_df = pd.read_excel (r"C:\Users\dhrvt\Downloads\Market Sizing.xlsx", sheet_name='Q1 Base - Modified')
...
def forecast_and_rank_districts(df, trade_cost_col="2024-Q1 TRADES", amt_cost_cols="2024-Q1 SANCTIONED AMT",
    ...
    try:
        ...
        risk_cols = ["% 90+ in 2023-Q3", "% 90+ in 2023-Q4", "% 90+ in 2024-Q1"]
        trade_cols = ["2023-Q3 TRADES", "2023-Q4 TRADES", "2024-Q1 TRADES"]
        amt_cols = ["2023-Q3 SANCTIONED AMT", "2023-Q4 SANCTIONED AMT", "2024-Q1 SANCTIONED AMT"]
        ...
        for district in districts:
            ...
            if len(risk_series) == 3 and not risk_series.isna().any():
                risk_series.index = pd.period_range(start="2023Q3", periods=3, freq='Q')
            ...
            if len(trades) == 3 and len(amts) == 3 and not trades.isna().any() and not amts.isna().any():
                profit_series = (trades + amts) / 2
                profit_series.index = pd.period_range(start="2023Q3", periods=3, freq='Q')
...
if st.button("📊 Run SARIMA + Multi-Objective Ranking"):
    try:
        results_df, error = forecast_and_rank_districts(st.session_state.market_data.copy())
        if error:
            ...
            st.dataframe(results_df[results_df["selected"]][["district", "forecasted_profit", "forecasted_risk", "score"]])
            explanation = (
